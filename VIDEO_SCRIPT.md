...
**Say:**
> "Hi, I'm [Your Name]. This is my Module 2 project - a Domestic Violence Support App. Let me show you how it works."
...
### B. Phone Integration
**Show:** EmergencyContactsScreen.js, scroll to the `handleCallContact` function
...
### D. State Management
**Show:** EmergencyContactsScreen.js, the useState and useEffect hooks
...
### E. Multiple Screens
**Show:** Quickly switch between 2-3 screen files
